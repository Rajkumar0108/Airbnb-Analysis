...
st.set_page_config(page_title= "Airbnb Data Visualization | By Rajkumar Vijay",
                   page_icon= icon,
                   layout= "wide",
...
client = pymongo.MongoClient("mongodb+srv://rajamudha07:Amudha01@cluster0.jwrp7.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
mg_db = client['sample_airbnb']
record = mg_db["listingsAndReviews"]
